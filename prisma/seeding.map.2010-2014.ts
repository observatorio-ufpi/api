...
export const mapeamentoReceitas: {
  ...
  '2.4- Cota-Parte IPI-Exportação': ItemReceitaTipos.COTA_PARTE_IPI_EXPORTACAO,
  ...
  '6.1- Transferências de Convênios': ItemReceitaTipos.TRANSFERENCIAS_CONVENIOS,
...
export const mapeamentoDeducoesFundebMagisterio: {
  [key: string]: DeducoesFundebMagisterioTipo;
} = {
  '16- RESTOS A PAGAR INSCRITOS NO EXERCÍCIO SEM DISPONIBILIDADE FINANCEIRA DE RECURSOS DO FUNDEB':
    DeducoesFundebMagisterioTipo.RESTOS_A_PAGAR_SEM_DISPONIBILIDADE_FINANCEIRA_FUNDEB,
  '17- DESPESAS CUSTEADAS COM O SUPERÁVIT FINANCEIRO, DO EXERCÍCIO ANTERIOR, DO FUNDEB':
    DeducoesFundebMagisterioTipo.DESPESAS_SUPERAVIT_FINANCEIRO_EXERCICIO_ANTERIOR_FUNDEB,
  '18- TOTAL DAS DEDUÇÕES CONSIDERADAS PARA FINS DE LIMITE DO FUNDEB (16 + 17)':
    DeducoesFundebMagisterioTipo.TOTAL_DEDUCOES_PARA_FINS_LIMITE_FUNDEB,
  '19- MÍNIMO DE 60% DO FUNDEB NA REMUNERAÇÃO DO MAGISTÉRIO COM EDUCAÇÃO INFANTIL E ENSINO FUNDAMENTAL ((13 – 18) / (11) x 100) %':
    DeducoesFundebMagisterioTipo.MINIMO_60_PORCENTO_FUNDEB_REMUNERACAO_MAGISTERIO_EDUCACAO,
};

export const mapeamentoControleUtilizacaoRecursos: {
  [key: string]: ControleUtilizacaoRecursosTipo;
} = {
  '20 – RECURSOS RECEBIDOS DO FUNDEB EM 2009 QUE NÃO FORAM UTILIZADOS':
    ControleUtilizacaoRecursosTipo.RECURSOS_NAO_UTILIZADOS_FUNDEB_ANO_ANTERIOR,
  '21 – DESPESAS CUSTEADAS COM O SALDO DO ITEM 20 ATÉ O 1o TRIMESTRE DE 20120':
    ControleUtilizacaoRecursosTipo.DESPESAS_CUSTEADAS_COM_FUNDEB_ANO_ANTERIOR_ATE_1_TRIM_ATUAL,
};

export const mapeamentoDeducoesParaFinsDeLimitesConstitucional: {
  [key: string]: DeducoesParaFinsDeLimitesConstitucionalTipo;
} = {
  '30- RESULTADO LÍQUIDO DAS TRANSFERÊNCIAS DO FUNDEB = (12)':
    DeducoesParaFinsDeLimitesConstitucionalTipo.RESULTADO_LIQUIDO_DAS_TRANSFERENCIAS_DO_FUNDEB,
  '31- DESPESAS CUSTEADAS COM A COMPLEMENTAÇÃO DO FUNDEB NO EXERCÍCIO':
    DeducoesParaFinsDeLimitesConstitucionalTipo.DESPESAS_CUSTEADAS_A_COMPLEMENTACAO_DO_FUNDEB_NO_EXERCICIO,
  '32- RECEITA DE APLICAÇÃO FINANCEIRA DOS RECURSOS DO FUNDEB ATÉ O BIMESTRE = (50 h)':
    DeducoesParaFinsDeLimitesConstitucionalTipo.RECEITA_DE_APLICACAO_FINANCEIRA_DOS_RECURSOS_DO_FUNDEB_ATE_BIM,
  '33- DESPESAS CUSTEADAS COM O SUPERÁVIT FINANCEIRO, DO EXERCÍCIO ANTERIOR, DO FUNDEB':
    DeducoesParaFinsDeLimitesConstitucionalTipo.DESPESAS_CUSTEADAS_SUPERAVIT_FINANCEIRO_DO_EXERCICIO_ANTERIOR,
  '34- DESPESAS CUSTEADAS COM O SUPERÁVIT FINANCEIRO, DO EXERCÍCIO ANTERIOR, DE OUTROS RECURSOS DE IMPOSTOS':
    DeducoesParaFinsDeLimitesConstitucionalTipo.DESPESAS_CUSTEADAS_SUPERAVIT_EXERCICIO_ANTERIOR_OUTROS_IMPOSTOS,
  '35- RESTOS A PAGAR INSCRITOS NO EXERCÍCIO SEM DISPONIBILIDADE FINANCEIRA DE RECURSOS DE IMPOSTOS VINCULADOS AO ENSINO':
    DeducoesParaFinsDeLimitesConstitucionalTipo.RESTOS_A_PAGAR_INSCRITOS_SEM_DISPONIBILIDADE_FINANCEIRA,
  '36- CANCELAMENTO, NO EXERCÍCIO, DE RESTOS A PAGAR INSCRITOS COM DISPONIBILIDADE FINANCEIRA DE RECURSOS DE IMPOSTOS VINCULADOS AO ENSINO = (46 g)':
    DeducoesParaFinsDeLimitesConstitucionalTipo.CANCELAMENTO_RESTOS_PAGAR_INSCRITOS_DISPONIBILIDADE_FINANCEIRA,
  '37- TOTAL DAS DEDUÇÕES CONSIDERADAS PARA FINS DE LIMITE CONSTITUCIONAL (30 + 31 + 32 + 33 + 34 + 35 + 36)':
    DeducoesParaFinsDeLimitesConstitucionalTipo.TOTAL_DE_DEDUCOES_PARA_FINS_DE_LIMITE_CONSTITUCIONAL,
  '38- TOTAL DAS DESPESAS PARA FINS DE LIMITE ((23 + 24) – (37))':
    DeducoesParaFinsDeLimitesConstitucionalTipo.TOTAL_DE_DESPESAS_PARA_FINS_DE_LIMITE,
  '39- MÍNIMO DE 25% DAS RECEITAS RESULTANTES DE IMPOSTOS EM M5 D((3E8) / (3) x 100) %':
    DeducoesParaFinsDeLimitesConstitucionalTipo.MINIMO_DE_25_PORCENTO_DAS_RECEITAS_RESULTANTES_DE_IMPOSTOS_MDE,
};

export const mapeamentoRestosAPagar: {
  [key: string]: RestosAPagarInscritosDisponibilidadesFinanceiraTipo;
} = {
  '46- RESTOS A PAGAR DE DESPESAS COM MDE':
    RestosAPagarInscritosDisponibilidadesFinanceiraTipo.RESTOS_A_PAGAR_DE_DESPESA_MDE,
};

export const mapeamentoFluxoFinanceiroDeRecursos: {
  [key: string]: FluxoFinanceiroDeRecursosTipos;
} = {
  '47- SALDO FINANCEIRO EM 31 DE DEZEMBRO DE 2009':
    FluxoFinanceiroDeRecursosTipos.SALDO_FINANCEIRO_31_DE_DEZEMBRO_ANO_ANTERIOR,
  '48- (+) INGRESSO DE RECURSOS ATÉ O BIMESTRE':
    FluxoFinanceiroDeRecursosTipos.INGRESSO_RECURSOS_ATE_BIM,
  '49- (-) PAGAMENTOS EFETUADOS ATÉ O BIMESTRE':
    FluxoFinanceiroDeRecursosTipos.PAGAMENTOS_EFETUADOS_ATE_BIM,
  '50- (+) RECEITA DE APLICAÇÃO FINANCEIRA DOS RECURSOS ATÉ O BIMESTRE':
    FluxoFinanceiroDeRecursosTipos.RECEITA_APLICACAO_FINANCEIRA_DOS_RECURSOS_ATE_BIM,
  '51- (=) SALDO FINANCEIRO NO EXERCÍCIO ATUAL':
    FluxoFinanceiroDeRecursosTipos.SALDO_FINANCEIRO_NO_EXERCICIO_ATUAL,
};
...
export const mapeamentoDespesas: {
  ...
  '24- ENSINO FUNDAMENTAL': ItemDespesaTipos.MDE_DESPESAS_ENSINO_FUNDAMENTAL,
